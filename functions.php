...
function nextgen_setup() {
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'nextgen' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'nextgen_custom_background_args', array(
...
function nextgen_scripts() {
	wp_enqueue_style( 'nextgen-style', get_stylesheet_uri() );

	wp_enqueue_script( 'nextgen-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'nextgen-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
